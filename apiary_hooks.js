...
hooks.before('СМРЛП > Получить список КМО > Получить список карт местных отражений', function(transaction) { transaction.skip = true; });
hooks.before('СМРЛП > Управление КМО > Получить параметры КМО', function(transaction) { transaction.skip = true; });
hooks.before('СМРЛП > Управление КМО > Изменить параметры КМО', function(transaction) { transaction.skip = true; });
hooks.before('СМРЛП > Управление КМО > Удалить КМО', function(transaction) { transaction.skip = true; });
...
hooks.before('Настройки экспорта > Запрос проверки соединения с FTP > Запрос проверки', function(transaction) { transaction.skip = true; });
hooks.before('Настройки экспорта > Запрос проверки соединения существующего FTP > Получить', function(transaction) { transaction.skip = true; });
